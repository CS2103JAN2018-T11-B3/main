...
* **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : adds a contact named `John Doe` to the reInsurance address book.
...
* `add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 g/Friends`
* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 g/Family t/criminal`
...
Returns a number of the size of the address book
Format: `count`
...
Sort all entries from the address book by given condition in lexicographical order. +
Format: `sort`
...
* *Add* `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS g/GROUP [t/TAG]...` +
e.g. `add n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665 g/priority t/friend t/colleague`
* *Clear* : `clear`
* *Delete* : `delete INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [g/GROUP] [t/TAG]...` +
