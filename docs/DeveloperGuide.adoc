...
.  Should be able to export database to a spreadsheet .csv format
...
.  Should be able to store client's data safely by encryption
...
Client Information
Client Information includes all personal details and metrics.
